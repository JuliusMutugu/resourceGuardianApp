...
class AppColors {
  ...
  static const List<Color> gradientSecondary = [Color(0xFF06B6D4), Color(0xFF0EA5E9)];
  static const List<Color> gradientSuccess = [Color(0xFF10B981), Color(0xFF059669)];
  static const List<Color> gradientWarning = [Color(0xFFF59E0B), Color(0xFFD97706)];
  static const List<Color> gradientError = [Color(0xFFEF4444), Color(0xFFDC2626)];
  static const List<Color> gradientSunset = [Color(0xFFF59E0B), Color(0xFFEC4899)];
  static const List<Color> gradientOcean = [Color(0xFF06B6D4), Color(0xFF3B82F6)];
  static const List<Color> gradientForest = [Color(0xFF10B981), Color(0xFF059669)];
